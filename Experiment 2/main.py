...
def align_file(file1, file2, model_name, gold,layernumber,distortionrate):
    # Model
    if model_name == 'simalign-argmax':
        aligner = model.Simalign(matching_methods='a',layer=layernumber,distortion=distortionrate)
    elif model_name == 'simalign-itermax':
        aligner = model.Simalign(matching_methods='i',layer=layernumber,distortion=distortionrate)
        ...
        for j in range(13):
            ...
            for i in list:
                if i =='eng_ces' :
                    ...
                    align_file(file1, file2, 'simalign-itermax', gold,layernumber,distortionrate)
